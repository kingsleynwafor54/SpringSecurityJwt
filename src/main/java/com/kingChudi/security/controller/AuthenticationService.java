...
import com.kingChudi.security.config.JwtService;
import com.kingChudi.security.model.Role;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest authenticate) {
        ...
        var user = repository.findByEmail(authenticate.getEmail()).orElseThrow();
        var jwtToken = jwtService.generateToken(user);
        return AuthenticationResponse.builder()
                .token(jwtToken)
                .build();
